...
public class QuizCreator {
	...
	public void createMultiAnswer(int type, int quizId, String title, String text, String answer, String order) throws SQLException {
		stmt.executeUpdate("INSERT INTO questions (type, quiz_id, title, text, answer, sequence) VALUES ('"+type+"', '"+quizId+"', '"+title+"', '"+text+"', '"+answer+"', '"+order+"');");
	}
}
