...
<ul>
<%
List<String> announcements = AdministrationManager.getAnnouncements(conn);
...
if (AdministrationManager.isAdmin(conn, username)) {
	...
	<p>New Announcement:<br> <textarea rows="4" cols="50" name="content"></textarea></p>
	<p><input type="submit" name="button" value="Add Announcement"></p>
	<p><a href="site_statistics.jsp">View Site Statistics</a></p>	
	<%
}
%>
